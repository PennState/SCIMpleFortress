...
public class ScimConfigurator implements ServletContextListener {
  ...
  @Inject
  private Instance<ScimFortressUserProvider> userProviderInstance;

  @Inject
  private Instance<ScimFortressGroupProvider> groupProviderInstance;

  @Inject
  private Instance<ScimFortressRoleProvider> roleProviderInstance;
